				...
				<div class="sidebar-categories">
					...
					<ul class="main-categories">
						<li class="main-nav-list"><a data-toggle="collapse" href="#fruitsVegetable" aria-expanded="false" aria-controls="fruitsVegetable"><span
								 class="lnr lnr-arrow-right"></span>ស្បែកជើងប៉ាតា<span class="number">(53)</span></a>
						...
						<li class="main-nav-list"><a data-toggle="collapse" href="#meatFish" aria-expanded="false" aria-controls="meatFish"><span
								 class="lnr lnr-arrow-right"></span>ស្បែកជើងកវែង<span class="number">(53)</span></a>
						...
						<li class="main-nav-list"><a data-toggle="collapse" href="#cooking" aria-expanded="false" aria-controls="cooking"><span
								 class="lnr lnr-arrow-right"></span>Loafer<span class="number">(53)</span></a>
						...
						<li class="main-nav-list"><a data-toggle="collapse" href="#beverages" aria-expanded="false" aria-controls="beverages"><span
								 class="lnr lnr-arrow-right"></span>ស្បែកជើង Oxford<span class="number">(24)</span></a>
						...
						<li class="main-nav-list"><a data-toggle="collapse" href="#homeAppliance" aria-expanded="false" aria-controls="homeAppliance"><span
								 class="lnr lnr-arrow-right"></span>Espadrille<span class="number">(15)</span></a>
						...
						<li class="main-nav-list"><a class="border-bottom-0" data-toggle="collapse" href="#babyCare" aria-expanded="false"
							 aria-controls="babyCare"><span class="lnr lnr-arrow-right"></span>កូនក្មេង<span class="number">(48)</span></a>
							...
							<div class="single-product">
								...
								<div class="product-details">
									...
									<div class="prd-bottom">
										...
										<a href="index.php?page=Shop/cart" class="social-info">
											<span class="ti-bag"></span>
											<p class="hover-text">ថែមចូលកន្ត្រក</p>
										</a>
										<a href="#" class="social-info">
											<span class="lnr lnr-heart"></span>
											<p class="hover-text">ចូលចិត្ត</p>
										</a>
										<a href="#" class="social-info">
											<span class="lnr lnr-sync"></span>
											<p class="hover-text">ប្រៀបធៀប</p>
										</a>
										<a href="index.php?page=shop/single-product" class="social-info">
			...
			<div class="row justify-content-center">
				<div class="col-lg-6 text-center">
					<div class="section-title">
						<h1>ការផ្តល់ជូនពិសេសប្រចាំសប្តាហ៍</h1>
						<p>មិនថាអ្នកទិញទំនិញតាមអ៊ីនធឺណិត ឬក្នុងហាងនោះទេ Nike តែងតែកំណត់បញ្ជីសារពើភណ្ឌមុនៗ
							ដើម្បីបង្កើតកន្លែងសម្រាប់រចនាប័ទ្មថ្មីៗ</p>
					</div>
				</div>
			</div>
			<div class="row">
