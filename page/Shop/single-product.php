				...
				<div class="col-lg-5 offset-lg-1">
					<div class="s_product_text">
						...
						<div class="card_area d-flex align-items-center">
							<a class="primary-btn" href="#">បន្តែមចូលកន្ត្រក</a>
			...
			<ul class="nav nav-tabs" id="myTab" role="tablist">
				<li class="nav-item">
					<a class="nav-link" id="home-tab" data-toggle="tab" href="#home" role="tab" aria-controls="home"
						aria-selected="true">ការពិពណ៌នា</a>
				</li>
				<li class="nav-item">
					<a class="nav-link" id="profile-tab" data-toggle="tab" href="#profile" role="tab"
						aria-controls="profile" aria-selected="false">ការបញ្ជាក់</a>
				</li>
				<li class="nav-item">
					<a class="nav-link" id="contact-tab" data-toggle="tab" href="#contact" role="tab"
						aria-controls="contact" aria-selected="false">មតិយោបល់</a>
				</li>
				<li class="nav-item">
					<a class="nav-link active" id="review-tab" data-toggle="tab" href="#review" role="tab"
						aria-controls="review" aria-selected="false">ពិនិត្យ</a>
				</li>
			</ul>
									...
									<div class="col-md-12">
										<div class="form-group">
											<input type="text" class="form-control" id="name" name="name"
												placeholder="ឈ្មោះ​ពេញ​របស់​អ្នក">
										</div>
									</div>
									<div class="col-md-12">
										<div class="form-group">
											<input type="email" class="form-control" id="email" name="email"
												placeholder="អ៊ី​ម៉េ​ល">
										</div>
									</div>
									<div class="col-md-12">
										<div class="form-group">
							...
							<div class="row total_rate">
								...
								<div class="col-6">
									<div class="rating_list">
										...
										<ul class="list">
											<li><a href="#">5 ផ្កាយ <i class="fa fa-star"></i><i
														class="fa fa-star"></i><i class="fa fa-star"></i><i
														class="fa fa-star"></i><i class="fa fa-star"></i> 01</a></li>
											<li><a href="#">4 ផ្កាយ <i class="fa fa-star"></i><i
														class="fa fa-star"></i><i class="fa fa-star"></i><i
														class="fa fa-star"></i><i class="fa fa-star"></i> 01</a></li>
											<li><a href="#">3 ផ្កាយ <i class="fa fa-star"></i><i
														class="fa fa-star"></i><i class="fa fa-star"></i><i
														class="fa fa-star"></i><i class="fa fa-star"></i> 01</a></li>
											<li><a href="#">2 ផ្កាយ <i class="fa fa-star"></i><i
														class="fa fa-star"></i><i class="fa fa-star"></i><i
														class="fa fa-star"></i><i class="fa fa-star"></i> 01</a></li>
											<li><a href="#">1 ផ្កាយ <i class="fa fa-star"></i><i
														class="fa fa-star"></i><i class="fa fa-star"></i><i
														class="fa fa-star"></i><i class="fa fa-star"></i> 01</a></li>
										</ul>
									</div>
							...
							<div class="review_box">
								...
								<form class="row contact_form"
									...
									<div class="col-md-12">
										<div class="form-group">
											<input type="text" class="form-control" id="name" name="name"
												placeholder="ឈ្មោះ​ពេញ​របស់​អ្នក" onfocus="this.placeholder = ''"
												onblur="this.placeholder = 'ឈ្មោះ​ពេញ​របស់​អ្នក'">
										</div>
									</div>
									<div class="col-md-12">
										<div class="form-group">
											<input type="email" class="form-control" id="email" name="email"
												placeholder="​អ៊ី​ម៉េ​ល" onfocus="this.placeholder = ''"
												onblur="this.placeholder = '​អ៊ី​ម៉េ​ល'">
										</div>
									</div>
									<div class="col-md-12">
										<div class="form-group">
											<input type="text" class="form-control" id="number" name="number"
												placeholder="លេខទូរសព្ទ" onfocus="this.placeholder = ''"
												onblur="this.placeholder = 'លេខទូរសព្ទ'">
										</div>
									</div>
									<div class="col-md-12">
										<div class="form-group">
											<textarea class="form-control" name="message" id="message" rows="1"
												placeholder="មតិយោបល់" onfocus="this.placeholder = ''"
												onblur="this.placeholder = 'មតិយោបល់'"></textarea></textarea>
										</div>
									</div>
									<div class="col-md-12 text-right">
